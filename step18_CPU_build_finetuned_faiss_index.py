"""
Step 18 — Build the FAISS index for the fine-tuned embeddings
# step18_build_finetuned_faiss.py - CPU-Friendly version
...
# --------------------------------------------------
# 2) Load the fine-tuned embeddings
# --------------------------------------------------
...
# --------------------------------------------------
# 4) Save the fine-tuned FAISS index
# --------------------------------------------------
